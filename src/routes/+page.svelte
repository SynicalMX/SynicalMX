...
<main class="flex h-screen flex-col items-center justify-center space-y-5">
	...
	<img
		src="favicon.png"
		alt="A picture of Gengar from Pokémon"
	...
	<div class="flex max-w-5xl justify-center gap-4 px-3">
		...
		<section class="flex w-1/3 flex-col gap-2 rounded-lg bg-zinc-800 p-4 shadow-lg items-center">
			...
			<div class="flex flex-row h-full items-center space-x-3">
				<!-- GitHub -->
				<a
					href="https://github.com/SynicalMX"
					target="_blank"
					class="size-8 fill-slate-200 hover:fill-violet-400"
				>
				...
				<!-- Discord -->
				<a
					href="https://discord.com/users/319948810505682944"
					target="_blank"
					class="size-8 fill-slate-200 mt-2 hover:fill-violet-400"
				>
				...
				<!-- YouTube -->
				<a
					href="https://youtube.com/@synicalmx"
					target="_blank"
					class="size-8 fill-slate-200 mt-1 hover:fill-violet-400"
				>
